package com.mashibing.activiti.h_exclusivegateway;
 ...
 */
public class ExclusiveGateWayTest extends ApplicationTests {
    @Resource
    ...
    private final String bpmnNameAndKey = "exclusiveGateWay";
