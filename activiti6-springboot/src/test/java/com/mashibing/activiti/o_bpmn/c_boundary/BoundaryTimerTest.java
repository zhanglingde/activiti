package com.mashibing.activiti.o_bpmn.c_boundary;
 ...
 */
public class BoundaryTimerTest extends ApplicationTests {
    @Resource
    private RepositoryService repositoryService;
    @Resource
    private RuntimeService runtimeService;

    private final String bpmnNameAndKey = "boundaryTimer";
    @Test
