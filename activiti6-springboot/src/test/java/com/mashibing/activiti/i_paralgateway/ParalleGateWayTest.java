package com.mashibing.activiti.i_paralgateway;
 ...
 */
public class ParalleGateWayTest extends ApplicationTests {
    @Resource
    ...
    private final String bpmnNameAndKey = "paralleGateWay";

    @Test
    public void deployment() {
        Deployment deployment = repositoryService.createDeployment().name("合同申请审核")
